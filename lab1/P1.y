...
%type <code> macro_statement_call
%type <code> statement
...
macro_statement_call : IDENTIFIER OPEN_PAREN macro_param_list CLOSED_PAREN SEMICOLON {
...
MacroDefStatement : DEFINE IDENTIFIER OPEN_PAREN macro_arg_list CLOSED_PAREN OPEN_CURLY statement_list CLOSED_CURLY {
        int x = getMacroIndex($IDENTIFIER);
        if(x>=0){
                yyerror("// Failed to parse macrojava code.");
                return;
        }
