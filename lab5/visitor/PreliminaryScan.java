...
public class PreliminaryScan<R,A> implements GJVisitor<R,A> {
   //
  ...
  public GlobalSymTab g = new GlobalSymTab();
   ...
   public R visit(Goal n, A argu) {
      ...
      g.add_function("MAIN", 0, n.f0.beginLine);
   ...
   public R visit(Procedure n, A argu) {
      ...
      g.add_function(func_name, num_args, n.f0.f0.beginLine);
   ...
   public R visit(Call n, A argu) {
      ...
      if(g.curr_func.max_args_used < n.f3.size())
      {
        g.curr_func.max_args_used = n.f3.size();
      }
   ...
   public R visit(Temp n, A argu) {
      R _ret=null;
      n.f0.accept(this, argu);
      int num = Integer.parseInt(n.f1.accept(this, argu).toString());
